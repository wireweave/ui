    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <p className="mb-1 text-[13px] text-[var(--color-muted-foreground)]">{title}</p>
          <div className="flex items-baseline gap-2">
            <p className="text-[28px] leading-none font-bold text-[var(--color-foreground)]">
...
export function StatCardGrid({ className, columns = 4, children, ...props }: StatCardGridProps) {
  return (
    <div
      className={cn(
        'grid gap-4',
